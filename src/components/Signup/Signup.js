...
async function callSignUpService(user) {
  ...
  if (user.username == null || user.email == null
    ...
    || user.password == null || user.psrepeat == null
    || user.country == null) {
...
export default function Signup() {
  ...
  const handleSubmit = async e => {
    ...
    const outcome = await callSignUpService(user);
    setMessage(outcome);
    console.log(outcome);
    return (
  ...
  return (
    <div>
      ...
      <div className='signup-wrapper'>
        ...
        <h6 className='signup-sub-title'>{"Please fill in this form to create an account."}</h6>
        <form onSubmit={handleSubmit}>
          <div className="form-container">

            <label for="username"><b>Username</b></label>
            <input type="text" placeholder="Enter Username" name="username" autoComplete="off" onChange={e => setUsername(e.target.value)} />
            ...
            <input type="text" placeholder="Tell something about yourself..." name="about" onChange={e => setAbout(e.target.value)} />

            <label for="country"><b>Select Country</b></label>
            <select for="country" name="country" onChange={e => setCountry(e.target.value)} required>
            ...
            <input type="password" placeholder="Enter Password" name="password" autoComplete="off" onChange={e => setPassword(e.target.value)} />

            <label for="psrepeat"><b>Re-enter Password</b></label>
            <input type="password" placeholder="Re-enter Password" name="psrepeat" autoComplete="off" onChange={e => setPsrepeat(e.target.value)} />
